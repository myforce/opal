...
# ADD LINK32 opals.lib ptclib.lib ptlib.lib $(VAG729LIB) $(QTLIBS) vfw32.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib imm32.lib wsock32.lib /nologo /subsystem:windows /machine:I386 /libpath:"$(QTDIR)/lib" /libpath:"$(VAG729DIR)/"
...
# ADD LINK32 opalsd.lib ptclibd.lib ptlibsd.lib winmm.lib snmpapi.lib mpr.lib $(VAG729LIB) $(QTLIBS) vfw32.lib kernel32.lib user32.lib gdi32.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib imm32.lib wsock32.lib /nologo /subsystem:windows /debug /machine:I386 /pdbtype:sept /libpath:"$(QTDIR)/lib" /libpath:"$(VAG729DIR)/"
