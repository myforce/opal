...
STATISTICS_FIELD_BEG(TxAudio, RoundTripTime)
  value.sprintf(m_printFormat, statistics.m_roundTripTime);
STATISTICS_FIELD_END(TxAudio, RoundTripTime)
...
STATISTICS_FIELD_BEG(TxVideo, RoundTripTime)
  value.sprintf(m_printFormat, statistics.m_roundTripTime);
