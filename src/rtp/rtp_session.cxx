...
{
  if (m_dataSocket == NULL || !m_remoteAddress.IsValid() || m_remoteDataPort == 0)
    return false;

  m_qos = qos;
  m_qos.m_remote.SetAddress(m_remoteAddress, m_remoteDataPort);
  return m_dataSocket->SetQoS(m_qos);
}
