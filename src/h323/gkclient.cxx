                                       ...
                                       const H323Connection & connection)
{
  ...
  H323_RTP_Session * session = dynamic_cast<H323_RTP_Session *>(connection.GetMediaSession(H323Capability::DefaultAudioSessionID));
  if (session != NULL) {
  ...
  session = dynamic_cast<H323_RTP_Session *>(connection.GetMediaSession(H323Capability::DefaultVideoSessionID));
  if (session != NULL) {
