...
PObject::Comparison H235_SIGNED<ToBeSigned>::Compare(const PObject & obj) const
{
  ...
  PAssert(PIsDescendant(this, H235_SIGNED<ToBeSigned>), PInvalidCast);
#endif
...
{
#ifndef PASN_LEANANDMEAN
  PAssert(PIsDescendant(this, H235_ENCRYPTED<ToBeEncrypted>), PInvalidCast);
#endif
...
{
#ifndef PASN_LEANANDMEAN
  PAssert(PIsDescendant(this, H235_HASHED<ToBeHashed>), PInvalidCast);
#endif
